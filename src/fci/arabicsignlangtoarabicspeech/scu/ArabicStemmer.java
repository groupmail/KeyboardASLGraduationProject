...
public class ArabicStemmer {
    ...
    static String  pathToStemmerFiles = new StringBuffer ( MainActivity.stemmerFiles + System.getProperty ( "file.separator" ) ).toString ( );
    ...
    {
        pathToStemmerFiles = new StringBuffer(MainActivity.stemmerFiles + System.getProperty ( "file.separator" ) ).toString();
        rootFound = false;
        stopwordFound = false;
        fromSuffixes = false;
